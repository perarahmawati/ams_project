...
Route::post('/asset-management/option-management/position-status/store', [PositionStatusController::class, 'store'])->name('pages.management.position-statuses.store');
