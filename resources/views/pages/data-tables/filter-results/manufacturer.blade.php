                            ...
                            <table id="filteredAssetTable" class="table table-bordered table-hover display">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('pages.data-tables.filter-results.manufacturer.show', $manufacturer_table->id) }}" class="btn btn-primary btn-sm text-white mr-1"><i class="fa-solid fa-eye mr-2"></i>Show</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
