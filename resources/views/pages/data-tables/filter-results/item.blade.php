                        ...
                        <div>
                            <table id="filteredAssetTable" class="table table-bordered table-hover display">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $no++ }}</td>
                                        <td>{{ $item_table->item->name }}</td>
                                        <td>{{ $item_table->manufacturer->name }}</td>
                                        <td>{{ $item_table->serial_number }}</td>
                                        <td>{{ $item_table->configurationStatus->name }}</td>
                                        ...
                                        <td>{{ $item_table->description }}</td>
                                        <td>{{ $item_table->positionStatus->name }}</td>
                                        <td>{{ $item_table->created_at }}</td>
                                        <td>
                                            <a href="{{ route('pages.data-tables.filter-results.item.show', $item_table->id) }}" class="btn btn-primary btn-sm text-white mr-1"><i class="fa-solid fa-eye mr-2"></i>Show</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
