                        ...
                        <div>
                            <table id="filteredAssetTable" class="table table-bordered table-hover display">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $no++ }}</td>
                                        <td>{{ $position_status_table->item->name }}</td>
                                        <td>{{ $position_status_table->manufacturer->name }}</td>
                                        <td>{{ $position_status_table->serial_number }}</td>
                                        <td>{{ $position_status_table->configurationStatus->name }}</td>
                                        ...
                                        <td>{{ $position_status_table->description }}</td>
                                        <td>{{ $position_status_table->positionStatus->name }}</td>
                                        <td>{{ $position_status_table->created_at }}</td>
                                        <td>
                                            <a href="{{ route('pages.data-tables.filter-results.position-status.show', $position_status_table->id) }}" class="btn btn-primary btn-sm text-white mr-1"><i class="fa-solid fa-eye mr-2"></i>Show</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
