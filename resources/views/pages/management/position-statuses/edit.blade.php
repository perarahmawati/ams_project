    ...
    <div>
        ...
        <form method="post" name="dataTableForm" id="dataTableForm" action="">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" placeholder="Name" class="form-control" value="{{$position_status->name}}" />
                <p></p>
            </div>
            <div>
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(response.status == true) {
                        window.location.href="{{ route('pages.management.position-statuses.index') }}"; 
                    } else {
